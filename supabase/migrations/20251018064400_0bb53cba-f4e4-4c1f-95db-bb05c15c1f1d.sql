-- Fix overly permissive RLS policies and email exposure (corrected)

-- 1. Drop and recreate experiments policies
DROP POLICY IF EXISTS "Users can view project experiments" ON public.experiments;
DROP POLICY IF EXISTS "Project participants can create experiments" ON public.experiments;
DROP POLICY IF EXISTS "Project participants can update experiments" ON public.experiments;
DROP POLICY IF EXISTS "Project owners and admins can delete experiments" ON public.experiments;
...
DROP POLICY IF EXISTS "Users can view task activities for accessible tasks" ON public.task_activities;
DROP POLICY IF EXISTS "Task participants can create activities" ON public.task_activities;
DROP POLICY IF EXISTS "Task participants can update activities" ON public.task_activities;
DROP POLICY IF EXISTS "Project owners and admins can delete activities" ON public.task_activities;
...
-- 3. Fix task_activity_log - make it append-only
DROP POLICY IF EXISTS "Users can view activity logs for accessible tasks" ON public.task_activity_log;
DROP POLICY IF EXISTS "System can create activity logs" ON public.task_activity_log;
...
-- 4. Fix task_responsible_users policies
DROP POLICY IF EXISTS "Users can view task assignments for accessible tasks" ON public.task_responsible_users;
DROP POLICY IF EXISTS "Project owners and admins can assign task responsibilities" ON public.task_responsible_users;
DROP POLICY IF EXISTS "Project owners and admins can remove task responsibilities" ON public.task_responsible_users;
...
-- 5. Fix task_comments visibility
DROP POLICY IF EXISTS "Users can view task comments for accessible tasks" ON public.task_comments;
...
-- 6. Remove email column from profiles table
